    ...
    $(document).ready(function(){
        if ($("#wmd-button-row").length >0){
            ...
            $('#wmd-button-row').append(
                '<li className="wmd-button" id="wmd-t-button" style="" title="文字样式自定义"><img' +
                ...
                '<li className="wmd-button" id="wmd-album-button" style="" title="插入相册"><img' +
                ...
                '<style>' +
                '.wmd-button-row{height: auto!important;}</style>');

            /*2. 点击按钮的弹出框*/
            // $('#text').before('<div className="wmd-button OwO" style="" title="插入表情"></div>');
            ...
            $(document).on('click', '#wmd-t-button', function() {
                ...
                $('body').append(
                    '<div id="TPanel">'+
                    '<div className="wmd-prompt-background" style="position: fixed; top: 0px; z-index: 1000; opacity: 0.5; height: 100%; left: 0px; width: 100%;"></div>'+
                    '<div className="wmd-prompt-dialog">'+
                    '<div>'+
                    '<p><b>文字样式自定义</b></p>'+
                    '<p>相关问题：<a href="https://auth.ihewro.com/user/docs/#/FAQ/main?id=%e4%b8%8d%e8%a7%a3%e6%9e%90%e8%a1%a8%e6%a0%bc%ef%bc%9f%e4%b8%8d%e8%a7%a3%e6%9e%90html%ef%bc%9f" target="_blank">无法解析HTML代码</a> </p>'+
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="t_ok">确定</button>'+
                    '<button type="button" className="btn btn-s" id="t_cancel">取消</button>'+
                    '</form>'+
                    '</div>'+
                    '</div>');
            ...
            $(document).on('click', '#wmd-hplayer-button', function() {
                ...
                $('body').append(
                    ...
                    '<div>'+
                    '<p><b>插入音乐</b></p>'+
                    '<p>请在下方的输入框内输入要插入的音乐地址 <p style="color: #ff0012">支持歌单地址，支持多种类型混合</p> <a target="_blank" href="https://auth.ihewro.com/user/docs/#/preference/shortCode?id=%e9%9f%b3%e4%b9%90">使用文档</a>'+
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="hplayer_ok">确定</button>'+
                    '<button type="button" className="btn btn-s" id="hplayer_cancel">取消</button>'+
                    '</form>'+
                    '</div>'+
                    '</div>');
            ...
            $(document).on('click', '#wmd-post-button', function() {
                ...
                $('body').append(
                    ...
                    '<div className="wmd-prompt-dialog">'+
                    '<div>'+
                    '<p><b>调用其他文章</b></p><p>你可以在当前文章中调用另一篇文章，达到文章之间的交流体验。<a target="_blank" href="https://auth.ihewro.com/user/docs/#/preference/shortCode?id=%e6%96%87%e7%ab%a0%e5%8d%a1%e7%89%87">使用文档</a></p>'+
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="post_ok">确定</button>'+
                    '<button type="button" className="btn btn-s" id="post_cancel">取消</button>'+
                    '</form>'+
                    '</div>'+
                    '</div>');
            });
            ...
            $(document).on('click', '#wmd-video-button', function() {
                ...
                $('body').append(
                    ...
                    '<div>'+
                    '<p><b>插入视频</b></p>'+
                    '<p>可以向文章中插入一个简约美观的视频播放器<a target="_blank" href="https://auth.ihewro.com/user/docs/#/preference/shortCode?id=%e8%a7%86%e9%a2%91">使用文档</a></p>'+
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="video_ok">确定</button>'+
                    '<button type="button" className="btn btn-s" id="video_cancel">取消</button>'+
                    '</form>'+
                    '</div>'+
                    '</div>');
            ...
            $(document).on('click', '#wmd-button-button', function() {//按钮
                ...
                $('body').append(
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="button_ok">确定</button>'+//按钮
                    '<button type="button" className="btn btn-s" id="button_cancel">取消</button>'+//按钮
                    '</form>'+
                    '</div>'+
                    '</div>');
                $('.wmd-prompt-dialog input').select();
            ...
            $(document).on('click', '#wmd-text-button', function() {//标签
                ...
                $('body').append(
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="text_ok">确定</button>'+//标签
                    '<button type="button" className="btn btn-s" id="text_cancel">取消</button>'+//标签
                    '</form>'+
                    '</div>'+
                    '</div>');
                $('.wmd-prompt-dialog input').select();
            ...
            $(document).on('click', '#wmd-ss-button', function() {//收缩框
                ...
                $('body').append(
                    ...
                    '</div>'+
                    '<form>'+
                    '<button type="button" className="btn btn-s primary" id="ss_ok">确定</button>'+//收缩框
                    '<button type="button" className="btn btn-s" id="ss_cancel">取消</button>'+//收缩框
                    '</form>'+
                    '</div>'+
                    '</div>');
                $('.wmd-prompt-dialog input').select();
            ...
            $(document).on('click','#hplayer_ok',function() {
                ...
                callback=$.ajax({
                    type:'POST',
                    url: LocalConst.MUSIC_API,
                    data:{data:$('.wmd-prompt-dialog input').val()},
                    async:false
                });

                // console.log("hplayer_ok");
                myField = document.getElementById('text');
            ...
            $(document).on('click','#t_ok',function() {
                ...
                if ($("#isCenter").is(':checked')){
                    insertContent = '<p className="center"'+color+'>'+content+'</p>';
                }else{
